...
impl Namespaces {
    pub fn new() -> Self {
        Self {
            helpers: quote!(crate::parser::utils::macros_helpers),
            error_mod: quote!(crate::error),
        }
    }
}
...
impl<'a> ParserGenerator<'a> {
    ...
    fn wrap_trait_impl(
        ...
        quote! {
            ...
            impl<S> crate::parser::parsable::KdlParsable<S> for #struct_name {
                fn parse_node(
    ...
    fn gen_node_schema_impl(&self, struct_name: &syn::Ident) -> TokenStream {
        ...
        quote! {
            impl crate::parser::node_schema::NodeSchema for #struct_name {
